...
//         Populate DB
        ...
        Batiment batimentC = new Batiment("BatimentC");
        ...
        Reservation reservation = new Reservation(LocalDateTime .now(),LocalDateTime.of(2023, 3, 18, 12, 30, 0), LocalDateTime.of(2023, 3, 18, 12, 30, 0), litItem, patient);

        Session session = GetSessionFactory.getSessionFactory().openSession();
        session.beginTransaction();
        session.save(batimentA);
        session.save(batimentB);
        session.save(batimentC);
